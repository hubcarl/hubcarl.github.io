---
layout: post
title: weg系列-基于fis3+express+swig的前端和后端集成打包解决方案weg
date: 2015-03-05
categories: blog
tags: [fis3,express swig,node.js,前端开发打包解决方案]
...
- weg-swig 基于swig进行扩展,支持html、head、body、pagelet、widget、script、style 等扩展标签
